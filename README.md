...
самостійно на вашій машині — середовище, у якому збирався цей проєкт, не має доступу
до інтернету для `npm install`, тож фінальну збірку перевірити не вдалося.
...
components/          — усі секції та інтерактивні віджети (у т.ч. AboutUs.tsx — блок «Про нас»)
lib/
  data.ts            — весь текстовий контент (проєкти, послуги, відгук, FAQ тощо)
  icons.tsx          — іконки та спільний логотип
public/              — статичні файли (наразі порожньо, фото в «Про нас» не використовується)
```
