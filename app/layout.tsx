...
export const metadata: Metadata = {
  title: "MaSayt",
  description:
    "Створюю сучасні сайти, які допомагають бізнесу зростати: лендінги, сайти-візитки та невеликі корпоративні сайти.",
  openGraph: {
    title: "Андрій Мастеров — веб-дизайнер і розробник сайтів",
