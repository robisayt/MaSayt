  ...
  return (
    <section id="process" className="py-14 sm:py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        ...
        <div className="relative grid sm:grid-cols-2 lg:grid-cols-6 gap-6 sm:gap-8 lg:gap-4">
          {PROCESS.map((step, i) => (
            <Reveal key={step.title} delay={(i % 3) * 90} className="relative flex flex-col items-start lg:items-center lg:text-center">
